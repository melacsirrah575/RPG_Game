...
namespace RPG.Dialogues.Editor
{
    public class DialogueEditor : EditorWindow
    {
        ...
        private void DrawLinktButtons(DialogueNode node)
        {
            ...
            } else if (linkingParentNode.children.Contains(node.uniqueID))
            {
                ...
                {
                    Undo.RecordObject(selectedDialogue, "Unlink Dialogue Link");
        ...
        private void DrawConnections(DialogueNode node)
        {
            ...
            foreach (DialogueNode childNode in selectedDialogue.GetAllChildren(node))
            {
                ...
                controlPointOffset.x *= 0.8f; //0.8fs just used to reduce harshness of curves
